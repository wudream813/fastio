...
#define FIO_ULTRA_STEPS_11 FIO_ULTRA_STEPS_10 FIO_ULTRA_STEP
#define FIO_ULTRA_STEPS_12 FIO_ULTRA_STEPS_11 FIO_ULTRA_STEP
#define FIO_ULTRA_STEPS_13 FIO_ULTRA_STEPS_12 FIO_ULTRA_STEP
#define FIO_ULTRA_STEPS_14 FIO_ULTRA_STEPS_13 FIO_ULTRA_STEP
#define FIO_ULTRA_STEPS_15 FIO_ULTRA_STEPS_14 FIO_ULTRA_STEP
#define FIO_ULTRA_STEPS_16 FIO_ULTRA_STEPS_15 FIO_ULTRA_STEP
#define FIO_ULTRA_STEPS_17 FIO_ULTRA_STEPS_16 FIO_ULTRA_STEP
#define FIO_ULTRA_STEPS_18 FIO_ULTRA_STEPS_17 FIO_ULTRA_STEP
#define FIO_ULTRA_STEPS_19 FIO_ULTRA_STEPS_18 FIO_ULTRA_STEP
...
#define FIO_ULTRA_PASTE(a, b) FIO_ULTRA_PASTE_(a, b)
        ...
        if (sizeof(U) > 8) {                    // （unsigned）__int128
            ...
            FIO_ULTRA_PASTE(FIO_ULTRA_STEPS_, FASTIO_PAIR_STEPS_I128)
#else
            FIO_ULTRA_STEPS_19                       // 最长 39 位 = 19 对 + 1 单
#endif
        } else if (sizeof(U) > 4) {            // 64 位
#ifdef FASTIO_PAIR_STEPS_LL
            FIO_ULTRA_PASTE(FIO_ULTRA_STEPS_, FASTIO_PAIR_STEPS_LL)
#else
            if (is_signed_of<T>::value) { FIO_ULTRA_STEPS_9 }   // ll 19 位 = 9 对 + 1 单
            else                        { FIO_ULTRA_STEPS_10 }  // ull 20 位 = 10 对
#endif
        } else {
...
#undef FIO_ULTRA_STEPS_11
#undef FIO_ULTRA_STEPS_12
#undef FIO_ULTRA_STEPS_13
#undef FIO_ULTRA_STEPS_14
#undef FIO_ULTRA_STEPS_15
#undef FIO_ULTRA_STEPS_16
#undef FIO_ULTRA_STEPS_17
#undef FIO_ULTRA_STEPS_18
#undef FIO_ULTRA_STEPS_19
